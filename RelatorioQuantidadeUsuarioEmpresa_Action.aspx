<%@ Page 
    ...
    CodeBehind="RelatorioQuantidadeUsuarioEmpresa_Action.aspx.cs" 
    Inherits="Sigee.RelatorioQuantidadeUsuarioEmpresa_Action" 
%>
     ...
     <asp:MultiView runat="server" ID="multiview">
        <asp:View ID="view" runat="server">
            ...
            <asp:Panel runat="server" ID="pnlRelatorio" CssClass="row mt">
                <div class="col-lg-12">
                    <h4 class="mb title">
                        Relatório Quantidade de Usuário x Empresa
                    </h4>   
