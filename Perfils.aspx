<%@ Page 
    ...
    CodeBehind="Perfils.aspx.cs" 
    Inherits="Sigee.Perfils" 
%>
                                   ...
                                   <div class="panel-body">
                                       <div class="table-responsive">
                                           <asp:GridView
                                               ...
                                               OnRowDeleting="grdPerfils_RowDeleting"
                                               OnPageIndexChanging="grdPerfils_PageIndexChanging"
                                               ...
                                               <PagerStyle Font-Size="Medium" />
                                                    <Columns>
                                                        <asp:BoundField 
                                                            DataField="NomPerfil" 
                                                            HeaderText="Nome do Perfil"
                                                            HeaderStyle-HorizontalAlign="Center" />
                                                        <asp:BoundField 
                                                            DataField="DtHrCadPerfil" 
                                                        ...
                                                        <asp:TemplateField HeaderText="Ativo">
                                                            <ItemTemplate>
                                                                <asp:Label
                                                                    runat="server"
                                                                    ID="Label1"
                                                                    Text='<%# (Eval("FlagAtivoPerfil").ToString().Equals("1")?"SIM":"NÃO") %>'>
                                                                </asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                 <asp:ImageButton
                                                                    ...
                                                                    CommandArgument='<%#Eval("CodPerfil").ToString() %>'
                                                    ...
                                                    <EmptyDataTemplate>
                                                        Não foi encontrado nenhum perfil para ser relacionado!
                                                    </EmptyDataTemplate>
                                           </asp:GridView>
                                       </div>
                                   </div>
